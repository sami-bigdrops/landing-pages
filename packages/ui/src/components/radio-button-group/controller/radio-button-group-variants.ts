...
export const radioOptionVariants = cva(optionBase, {
  variants: {
    type: {
      "1":
        "inline-flex items-center gap-3 rounded-lg border border-input bg-background py-3.5 px-4 text-base text-foreground hover:bg-muted/50 hover:border-primary/30",
      "2":
        "rounded-full border-2 border-input bg-background px-5 py-3 text-base text-foreground hover:border-primary/50 hover:bg-muted/50",
      "3":
        "rounded-lg border-2 border-input bg-background px-5 py-3.5 text-base text-foreground hover:border-primary/50 hover:bg-muted/50",
      "4":
        "flex-1 rounded-none border border-input border-r-0 last:border-r bg-background px-4 py-3 text-center text-base text-foreground first:rounded-l-md last:rounded-r-md hover:bg-muted/50",
    },
  },
  defaultVariants: {
    type: "1",
