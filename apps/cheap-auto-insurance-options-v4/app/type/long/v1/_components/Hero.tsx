...
const BASE_URL = "https://savingsform.cheapautoinsuranceoptions.com";
          ...
          <div className="hero-content w-full flex flex-col items-center justify-center  gap-5 md:gap-10 xl:gap-11 ">
            <div className="w-full flex flex-col items-center justify-center  gap-5 md:gap-7 xl:gap-9">
              <div className="w-full flex flex-col items-center  gap-2 xl:gap-3">
                <h1
                  className="text-[1.5rem] md:text-3xl xl:text-5xl max-w-[250px] md:max-w-[420px] lg:max-w-[420px] xl:max-w-[620px] font-extrabold text-[#102A43] text-center font-sans"
                  style={{
                    lineHeight: "1.3",
                  }}
                >
                  <span
                    className="relative -top-[0.35em] mr-px inline-block text-[0.45em] font-extrabold leading-none align-super"
                    aria-hidden
                  >
                    *
                  </span>
                ...
                <div className="w-full flex flex-col items-center justify-center gap-4 md:gap-4 lg:gap-5 xl:gap-7  ">
                  ...
                  <div className="w-full space-y-4 sm:space-y-0  xl:max-w-full">
                    ...
                    <form
                      data-arohaa-zip-form
                      onSubmit={handleSubmit}
                      className="hidden relative w-full sm:flex w-full flex-row items-center justify-center  gap-2.5 xl:gap-3.5"
                    >
