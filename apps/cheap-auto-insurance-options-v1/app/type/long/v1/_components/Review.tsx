...
export default function Review() {
  return (
    <div className="review bg-white w-full h-full px-6 py-8 md:px-8 md:py-8 lg:px-14 lg:py-10 xl:px-23 xl:py-14">
      <div className="container mx-auto">
        <div className="review-content w-full flex flex-col items-center justify-center gap-8 md:gap-10 lg:gap-10 xl:gap-16 ">
          <h2 className="text-[1.4rem] text-center  md:text-2xl xl:text-4xl  lg:max-w-full font-bold text-[#102A43] text-center font-sans ">
            {REVIEW_CONTENT.header}
          </h2>

          <div className="w-full">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-5 md:gap-4 lg:gap-6 xl:gap-6 2xl:gap-14">
              {REVIEW_CONTENT.reviews.map((review) => (
                <div
                  key={review.id}
                  className="w-full md:w-auto min-w-0 bg-white border border-[#CDD1D8] shadow-[0_4px_15px_0_rgba(16,46,80,0.02)] rounded-[15px] flex flex-col items-start justify-start gap-4 p-5 py-6 xl:p-6 lg:gap-5.5 xl:gap-5 min-h-[260px] xl:min-h-[250px]"
                >
                  ...
                  <div className="w-full flex items-center justify-between gap-3">
                    ...
                    {REVIEW_CONTENT.badge.map((badge) => (
                      <div
                        key={badge.text}
                        className="inline-flex shrink-0 items-center gap-1 xl:gap-1.5"
                      >
                        <Image
                          src={badge.icon}
                          alt=""
                          ...
                          aria-hidden
                        />
                        <span className="text-xs xl:text-sm font-normal text-[#374151] font-sans">
                          {badge.text}
                        </span>
                      </div>
                    ))}
                  ...
                  <div className="w-full flex flex-col items-start justify-start xl:flex-row xl:items-center xl:justify-between gap-2 mt-auto">
                    <div className="flex items-center justify-start gap-3  ">
                      ...
                      <div className="flex flex-col items-start justify-start gap-0.5">
                        <p className="font-semibold text-sm lg:text-sm xl:text-base text-[#212A31] font-sans">
