            ...
            <div className="bg-white rounded-lg shadow-lg p-6 md:p-8">
              ...
              <div className="flex flex-col gap-8">
                <div>
                  ...
                  <p className="text-sm sm:text-base md:text-lg leading-relaxed mb-5 text-[#1e1e1e] font-inter">
                    You may opt-out of this arbitration provision only by written notice to us at the Notice Address (<a href="mailto:contact@assurerates.com" className="text-blue-600 hover:text-blue-800 font-inter">contact@assurerates.com</a>) within thirty (30) days of your acceptance of this agreement, which notice shall include your name, address, and a clear statement that you do not wish to resolve disputes with us through arbitration.
                  </p>
                  <p className="text-sm sm:text-base md:text-lg leading-relaxed mb-5 text-[#1e1e1e] font-inter">
                  ...
                  <p className="text-sm sm:text-base md:text-lg leading-relaxed mb-5 text-[#1e1e1e] font-inter">
                    Except as explicitly stated otherwise, any notices sent from you to us shall be submitted via e-mail at <a href="mailto:contact@assurerates.com" className="text-blue-600 hover:text-blue-800 font-inter">contact@assurerates.com</a>. When we need to send a notice to you, it shall be sent to the e-mail address you last provided to us. Notice shall be deemed given upon receipt or 24 hours after e-mail is sent, unless the sending party is notified that the e-mail address is invalid.
                  </p>
                  <p className="text-sm sm:text-base md:text-lg leading-relaxed mb-5 text-[#1e1e1e] font-inter">
                  ...
                  <p className="text-sm sm:text-base md:text-lg leading-relaxed mb-5 text-[#1e1e1e] font-inter">
                    At any time, you can update the email address to which we will send alerts that Disclosures are available. You can change your email address by contacting us at: <a href="mailto:contact@assurerates.com" className="text-blue-600 hover:text-blue-800 font-inter">contact@assurerates.com</a>
                  </p>
                  <p className="text-sm sm:text-base md:text-lg leading-relaxed mb-5 text-[#1e1e1e] font-inter">
                  ...
                  <p className="text-sm sm:text-base md:text-lg leading-relaxed mb-5 text-[#1e1e1e] font-inter">
                    If you have any questions regarding any of these Terms, please contact us by emailing <a href="mailto:contact@assurerates.com" className="text-blue-600 hover:text-blue-800 font-inter">contact@assurerates.com</a>.
                  </p>
                  <p className="text-sm sm:text-base md:text-lg leading-relaxed mb-5 text-[#1e1e1e] font-inter">
