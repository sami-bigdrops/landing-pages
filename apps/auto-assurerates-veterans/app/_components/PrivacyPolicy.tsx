            ...
            <div className="bg-white rounded-lg shadow-lg p-6 md:p-8">
              ...
              <div className="flex flex-col gap-8">
                <div>
                  ...
                  <p className="text-sm sm:text-base md:text-lg leading-relaxed mb-5 text-[#1e1e1e] font-inter">
                    If you are a California resident, you have the right to (1) request more information about the categories and specific pieces of personal information we have collected, sold and disclosed for a business purpose in the last 12 months, (2) request deletion of your personal information, (3) opt out of the sale of your personal information, if applicable, and (4) be free from discrimination for exercising your rights under the CCPA. You may make these requests by emailing <a href="mailto:contact@assurerates.com" className="text-blue-600 hover:text-blue-800 font-inter">contact@assurerates.com</a> To opt out of sales, you can email <a href="mailto:contact@assurerates.com" className="text-blue-600 hover:text-blue-800 font-inter">contact@assurerates.com</a>. We will verify your request by confirming at least two pieces of personal information, including contact information, you provided in submitting your form. To designate an authorized agent to exercise these rights on your behalf, send an email with your request to <a href="mailto:contact@assurerates.com" className="text-blue-600 hover:text-blue-800 font-inter">contact@assurerates.com</a>.
                  </p>
                  ...
                  <p className="text-sm sm:text-base md:text-lg leading-relaxed mb-5 text-[#1e1e1e] font-inter">
                    If you have any questions about this Policy, please email us at <a href="mailto:contact@assurerates.com" className="text-blue-600 hover:text-blue-800 font-inter">contact@assurerates.com</a>.
                  </p>
