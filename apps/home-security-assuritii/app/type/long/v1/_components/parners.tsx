...
const PARTNER_LOGO_FRAME: Record<PartnerName, string> = {
  "ADT":
    "flex h-3 w-auto  md:w-auto shrink-0 items-center justify-center",
  "vivint.":
    "flex h-3 w-auto  md:w-auto shrink-0 items-center justify-center",
  "BRINKS HOME":
    "flex h-3 w-auto  md:w-auto shrink-0 items-center justify-center",
  ...
  return (
    <section className="w-full bg-[#F3F4F6] p-6 md:px-8 md:py-10 lg:px-12 lg:py-12 xl:px-20 xl:py-14">
      <div className="mx-auto flex w-full max-w-6xl flex-col items-center gap-6 md:flex-row md:items-center md:justify-center md:gap-12 lg:gap-14 xl:gap-20 ">
        ...
        <div
          className="flex w-full max-w-md flex-row flex-nowrap items-center justify-center gap-5 sm:gap-6 md:w-auto md:max-w-none md:gap-6 lg:gap-8 xl:gap-10"
