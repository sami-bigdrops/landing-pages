      ...
      <div className="container mx-auto">
        <div className="review-content w-full flex flex-col items-center justify-center gap-6 md:gap-8 lg:gap-10 xl:gap-14 ">
          ...
          <div className="w-full">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-4 lg:gap-6 xl:gap-8 2xl:gap-14">
              {REVIEW_CONTENT.reviews.map((review, index) => (
                <div
                  key={review.id}
                  className={cn(
                    'w-full md:w-auto min-w-0 bg-white border-[1.5px] border-[#C0CDEA] rounded-[20px] flex flex-col items-start justify-start gap-4 p-5 xl:p-6 lg:gap-4 xl:gap-5 min-h-[260px] lg:min-h-[200px] xl:min-h-[250px]',
                ...
                >
                  <div className="flex items-center justify-start w-full">
                    <Image
                      ...
                      width={24}
                      height={24}
                      className="w-6.5 h-6.5 xl:w-8 xl:h-8 object-contain "
                    />
                    
                  </div>

                  <p className="text-[0.9rem]  xl:text-[1.05rem] xl:max-w-[330px] text-[#0F172A] font-inter flex-1" style={{ lineHeight: 1.6 }}>
                    {review.quote}
                  </p>

                  <div className="w-full flex flex-col-reverse items-start justify-start xl:flex-row xl:items-center xl:justify-between gap-4 mt-auto">
                    <div className="flex  items-center justify-start gap-3 xl:w-[58%] ">
                      ...
                      <div>
                        <p className="font-semibold text-sm  xl:text-base text-[#0F172A] font-inter">
                          {review.customer.name}
                        </p>
                        <p className="text-[0.83rem] md:text-[0.83rem] xl:text-sm text-[#374151] font-inter">
