              ...
              <div className="flex flex-col gap-8">
                <div>
                  ...
                  <p className="text-sm sm:text-base md:text-lg leading-relaxed mb-5 text-[#1e1e1e] font-inter">
                    By accessing insurlii.com, using any of our services and/or accessing and using any other websites on which these Terms and Conditions reside (collectively also referred to herein as the &quot;Site&quot;), or any of the Sites&apos;s Content (as defined below), you acknowledge that you agree to and are subject to the following Terms and Conditions, including without limitation, binding arbitration (described in Section 2 below), the insurlii <Link href="/privacy-policy" className="text-blue-600 hover:text-blue-800 font-bold font-inter">Privacy Policy</Link>, E-Sign Consent, and any operating rules, policies, and procedures that may be published from time to time on this Site (collectively, the &quot;Terms&quot;). NOTE THAT THESE TERMS CONTAIN PROVISIONS THAT GOVERN THE RESOLUTION OF DISPUTES BETWEEN US AND YOU AND THAT LIMIT OUR LIABILITY TO YOU.
                  </p>
                  <p className="text-sm sm:text-base md:text-lg leading-relaxed mb-5 text-[#1e1e1e] font-inter">
                    If you do not agree to these Terms, you may not access or otherwise use the Site or the Content. The Terms constitute a legally binding agreement between you and us, insurlii.com, the operator of the Site (hereafter referred to as &quot;we&quot;, &quot;us&quot; or &quot;our&quot;). References in these Terms to &quot;Site operator,&quot; &quot;we&quot;, &quot;us&quot; and &quot;our&quot; include our affiliates (including, without limitation, insurlii, Inc.), agents, successors and assigns. The Site is available only to, and may only be used by, individuals who can form legally binding contracts under applicable law. Without limiting the foregoing, the Site is intended for and made available only to residents of the United States, age 18 or older. By accessing and using the Site, you accept and agree to, without qualification, the Terms and represent and warrant that you have the authority to bind the User (as defined below) to these Terms and that your use of the Site, including the provision or use of any Content, does not violate any applicable law.
                  </p>
                  ...
                  <p className="text-sm sm:text-base md:text-lg leading-relaxed mb-5 text-[#1e1e1e] font-inter">
                    You may opt-out of this arbitration provision only by written notice to us at the Notice Address (<a href="mailto:contact@insurlii.com" className="text-blue-600 hover:text-blue-800 font-inter">contact@insurlii.com</a>) within thirty (30) days of your acceptance of this agreement, which notice shall include your name, address, and a clear statement that you do not wish to resolve disputes with us through arbitration.
                  </p>
                  <p className="text-sm sm:text-base md:text-lg leading-relaxed mb-5 text-[#1e1e1e] font-inter">
                  ...
                  <p className="text-sm sm:text-base md:text-lg leading-relaxed mb-5 text-[#1e1e1e] font-inter">
                    Unauthorized access to and/or use of the Site, or the telecommunications or computer facilities used to deliver the Site, is a breach of these Terms and is a violation of law. Further, unauthorized access to and/or use of the Application may result in your license to use the Application being terminated immediately, and you may be denied future participation in any telematics offering distributed by insurlii. Your internet service provider and/or mobile carrier may also remove you from their services in response to violations of these Terms applicable to the Application. If you are or become aware of or experience any Content, activity or communication through or in connection with the Site that appears to be in violation of the above, or in violation of any other provision of these Terms, we ask that you please inform us of any such violation by sending notification to <a href="mailto:contact@insurlii.com" className="text-blue-600 hover:text-blue-800 font-inter">contact@insurlii.com</a>.
                  </p>
                  ...
                  <p className="text-sm sm:text-base md:text-lg leading-relaxed mb-5 text-[#1e1e1e] font-inter">
                    Except as explicitly stated otherwise, any notices sent from you to us shall be submitted via e-mail at <a href="mailto:contact@insurlii.com" className="text-blue-600 hover:text-blue-800 font-inter">contact@insurlii.com</a>. When we need to send a notice to you, it shall be sent to the e-mail address you last provided to us. Notice shall be deemed given upon receipt or 24 hours after e-mail is sent, unless the sending party is notified that the e-mail address is invalid.
                  </p>
                  <p className="text-sm sm:text-base md:text-lg leading-relaxed mb-5 text-[#1e1e1e] font-inter">
                  ...
                  <div className="text-sm sm:text-base md:text-lg leading-relaxed mb-5 text-[#1e1e1e] font-inter">
                    In this E-Sign Consent, the following definitions apply: (i) &quot;You&quot; and &quot;your&quot; refer to you, the User; (ii) &quot;We,&quot; &quot;us,&quot; and &quot;our&quot; refer to the Site operator and its affiliates (including, without limitation, insurlii, Inc.), agents, successors and assigns. By clicking the &quot;I agree&quot; button, which you adopt as your electronic signature, you consent and agree that:
                    <ul className="list-disc list-inside mt-4 ml-4 sm:ml-6 md:ml-8 space-y-2 font-inter">
                  ...
                  <div className="text-sm sm:text-base md:text-lg leading-relaxed mb-5 text-[#1e1e1e] font-inter">
                    ...
                    <ul className="list-disc list-inside mt-4 ml-4 sm:ml-6 md:ml-8 space-y-2 font-inter">
                      ...
                      <li>If you use a spam filter that blocks or re-routes emails from senders not listed in your email address book, you must add @insurlii.com to your email address book.</li>
                    </ul>
                  </div>
                  <p className="text-sm sm:text-base md:text-lg leading-relaxed mb-5 text-[#1e1e1e] font-inter">
                  ...
                  <p className="text-sm sm:text-base md:text-lg leading-relaxed mb-5 text-[#1e1e1e] font-inter">
                    At any time, you can update the email address to which we will send alerts that Disclosures are available. You can change your email address by contacting us at: <a href="mailto:contact@insurlii.com" className="text-blue-600 hover:text-blue-800 font-inter">contact@insurlii.com</a>
                  </p>
                  <p className="text-sm sm:text-base md:text-lg leading-relaxed mb-5 text-[#1e1e1e] font-inter">
                  ...
                  <p className="text-sm sm:text-base md:text-lg leading-relaxed mb-5 text-[#1e1e1e] font-inter">
                    If you have any questions regarding any of these Terms, please contact us by emailing <a href="mailto:contact@insurlii.com" className="text-blue-600 hover:text-blue-800 font-inter">contact@insurlii.com</a>.
                  </p>
                  <p className="text-sm sm:text-base md:text-lg leading-relaxed mb-5 text-[#1e1e1e] font-inter">
