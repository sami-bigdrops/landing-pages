...
export default function Partners() {
  return (
    <div
      className="partners w-full h-full px-6 py-8 md:px-8 md:py-8 lg:px-14 lg:py-8 xl:px-23 xl:py-12"
      
    >
      <div className="container mx-auto max-w-[1300px] ">
        <div className="partners-content w-full flex flex-col items-center justify-center gap-8 md:gap-8 xl:gap-10">
          <h2 className="text-base lg:text-lg xl:text-xl font-semibold text-[#102A43] text-center font-sans "style={{
            lineHeight: "1.5",
          }}>
