          ...
          <div>
            ...
            <div className="mt-1 relative">
              <input
                ...
                className="w-full rounded-md border border-zinc-300 px-3 py-2 pr-10 text-sm outline-none focus:border-[color:var(--brand-primary)]"
              ...
              <button
                ...
                className="absolute inset-y-0 right-2 inline-flex items-center text-zinc-500 hover:text-zinc-700"
