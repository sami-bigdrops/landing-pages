...
const PAGE_TITLE =
  "text-center font-sans text-[1.4rem] font-bold text-[#0E2651] md:text-[1.6rem] lg:text-[1.7rem] xl:text-[1.9rem]"
    ...
    <section className="flex w-full flex-1 flex-col ">
      <div className="container mx-auto flex w-full max-w-[900px] flex-1 flex-col items-center">
        ...
        >
          ...
          <div className="mt-2 flex w-full max-w-[560px] md:max-w-[420px]  xl:max-w-[540px] items-start justify-between gap-3 px-1 md:mt-6 xl:mt-8 md:gap-6  xl:gap-10">
