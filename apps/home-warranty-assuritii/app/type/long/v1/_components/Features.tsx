      ...
      <div className="container mx-auto">
        <div className="features-content w-full flex flex-col items-center justify-center md:flex-row  md:justify-between gap-6 md:gap-10 lg:gap-14 xl:gap-14">
          <div className="left flex flex-col items-center justify-center md:items-start gap-3 md:gap-4 xl:gap-6 md:w-[35%] xl:w-[45%] ">
            <h2 className="text-2xl md:text-2xl lg:text-2xl xl:text-3xl lg:max-w-[250px]  xl:max-w-[400px] font-bold text-[#111827] text-center md:text-left font-inter" style={{ lineHeight: '1.2' }}>
              ...
              {FEATURES_CONTENT.features.map((feature) => (
                ...
                >
                  <div className=" flex items-center justify-center">
                    ...
                    <h3 className="text-[0.9rem]   lg:text-base xl:text-[1.2rem] md:max-w-[120px] lg:max-w-full  font-medium text-[#111827] text-left font-inter">
                      {feature.title}
                    </h3>
