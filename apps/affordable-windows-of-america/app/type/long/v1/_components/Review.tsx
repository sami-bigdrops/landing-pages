...
export default function Review() {
  return (
    <div className="review bg-[#F3F4F6] w-full h-full px-4 py-8 md:px-6 md:py-8 lg:px-14 lg:py-10 xl:px-20 xl:py-14">
      <div className="container mx-auto">
        ...
        <h2 className="text-2xl lg:text-3xl xl:text-4xl font-bold text-[#111827] text-center font-sans md:max-w-[400px] lg:max-w-[500px] xl:max-w-[600px] leading-tight tracking-tight">
            <span>
              {REVIEW_CONTENT.headerParts.before}
            </span>
            {" "}<span
              style={{
                background: REVIEW_CONTENT.headingGradient,
                WebkitBackgroundClip: "text",
                WebkitTextFillColor: "transparent",
                backgroundClip: "text",
              }}
            >{REVIEW_CONTENT.headerParts.gradient}</span>
          </h2>
          ...
          <div className="w-full">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-4 lg:gap-6 xl:gap-10">
              {REVIEW_CONTENT.reviews.map((review) => (
                <div
                  key={review.id}
                  className="w-full md:w-auto min-w-0 bg-white border border-[#D1D5DB] shadow-[2px_2px_15px_0_rgba(31,58,95,0.10)] flex flex-col items-start justify-start gap-4 p-6 xl:gap-5 xl:p-7 min-h-[280px]"
                >
                  ...
                  <p className="text-sm lg:text-base xl:text-lg xl:max-w-[330px] text-[#374151] font-sans flex-1" style={{ lineHeight: 1.5 }}>
                    &quot;{review.quote}&quot;
                  </p>
