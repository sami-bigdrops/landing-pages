...
export default function Features() {
  return (
    <div className="features bg-[#F3F6FA] w-full h-full p-4 md:p-6 lg:px-14 lg:py-10 xl:px-20 xl:py-16">
          ...
          <div className="right flex flex-col items-center justify-center gap-3 w-full lg:w-[60%] xl:w-[55%] ">
            <div className="grid grid-cols-1  gap-6 md:gap-5 lg:gap-6 xl:gap-7 w-full">
              {FEATURES_CONTENT.features.map((feature) => (
                <div 
                  key={feature.title} 
                  className="flex flex-col items-start justify-center md:flex-row md:max-w-[540px] lg:max-w-[570px] xl:max-w-[670px]  mx-auto gap-3.5 bg-white rounded-[10px] shadow-[0_0_30px_0_rgba(15,36,64,0.10)] p-5 md:p-4 xl:p-4.5 "
                >
