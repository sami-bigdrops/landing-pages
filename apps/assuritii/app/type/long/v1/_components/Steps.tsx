...
export default function Steps() {
  return (
    <div className="steps bg-[#F3F6FA] w-full h-full p-4 md:p-6 lg:px-14 lg:py-10 xl:px-20 xl:py-16">
                ...
                <div className="flex flex-col-reverse items-center justify-center gap-2 lg:gap-5 w-full">
                  <div className="flex-1 flex flex-col items-center justify-center gap-1.5">
                    <div className="flex items-center gap-1.5">
                      <span className="text-base lg:text-lg xl:text-xl font-semibold text-[#111827] font-['Inter']">
                        {step.number}.
                      </span>
                      <h3 className="text-base lg:text-lg xl:text-xl font-semibold text-[#111827] font-['Inter']">
                        {step.title}
                      </h3>
                    </div>
                    <p className="text-sm lg:text-[0.95rem] xl:text-[1.05rem] xl:max-w-[310px] mx-auto text-[#374151] text-center  font-['Inter']">
                      {step.description}
                    </p>
                  </div>
