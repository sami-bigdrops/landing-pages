      ...
      <div className="container mx-auto">
        <div className="terms-and-conditions-content w-full flex flex-col gap-6 md:gap-8 lg:gap-10 xl:gap-12">
          ...
          <div className="content-body flex flex-col gap-4 md:gap-5 lg:gap-6 xl:gap-7 max-w-4xl mx-auto">
            ...
            <div className="terms-section mt-4 md:mt-6">
              <h3 className="text-xl lg:text-2xl xl:text-3xl font-bold text-[#111827] font-sans">5. PROHIBITED USER CONDUCT.</h3>
              <p className="text-sm lg:text-[0.95rem] xl:text-[1.05rem] text-[#374151] font-sans mt-3 md:mt-4" style={{ lineHeight: '1.6' }}>
            ...
            <div className="terms-section mt-4 md:mt-6">
              <h3 className="text-xl lg:text-2xl xl:text-3xl font-bold text-[#111827] font-sans">6. MARKETING MATERIALS.</h3>
              <p className="text-sm lg:text-[0.95rem] xl:text-[1.05rem] text-[#374151] font-sans mt-3 md:mt-4" style={{ lineHeight: '1.6' }}>
            ...
            <div className="terms-section mt-4 md:mt-6">
              <h3 className="text-xl lg:text-2xl xl:text-3xl font-bold text-[#111827] font-sans">7. THIRD PARTY CONTENT/PROMOTIONS, THIRD PARTY PRODUCTS, AND THIRD PARTY WEBSITE ACTIVITIES.</h3>
              <p className="text-sm lg:text-[0.95rem] xl:text-[1.05rem] text-[#374151] font-sans mt-3 md:mt-4" style={{ lineHeight: '1.6' }}>
            ...
            <div className="terms-section mt-4 md:mt-6">
              <h3 className="text-xl lg:text-2xl xl:text-3xl font-bold text-[#111827] font-sans">8. RELATIONSHIP WITH MARKETING PROVIDERS.</h3>
              <p className="text-sm lg:text-[0.95rem] xl:text-[1.05rem] text-[#374151] font-sans mt-3 md:mt-4" style={{ lineHeight: '1.6' }}>
            ...
            <div className="terms-section mt-4 md:mt-6">
              <h3 className="text-xl lg:text-2xl xl:text-3xl font-bold text-[#111827] font-sans">9. LINKED WEBSITES.</h3>
              <p className="text-sm lg:text-[0.95rem] xl:text-[1.05rem] text-[#374151] font-sans mt-3 md:mt-4" style={{ lineHeight: '1.6' }}>
            ...
            <div className="terms-section mt-4 md:mt-6">
              <h3 className="text-xl lg:text-2xl xl:text-3xl font-bold text-[#111827] font-sans">10. ELECTRONIC COMMUNICATIONS/NOTICES AND INFORMATION DELIVERED ELECTRONICALLY.</h3>
              <p className="text-sm lg:text-[0.95rem] xl:text-[1.05rem] text-[#374151] font-sans mt-3 md:mt-4" style={{ lineHeight: '1.6' }}>
                Uncle Sam Buys Homes and Providers may choose to electronically deliver all information related to its services and your requests. Uncle Sam Buys Homes and Providers electronic communications to you may transmit or convey information about action taken on your request, portions of your request that may be incomplete or require additional explanation, any notices required under applicable law, which may include any Federal Truth-in-Lending disclosures, State disclosures, other terms, conditions and documents, and the privacy policies of Uncle Sam Buys Homes and Providers.
              </p>
              <p className="text-sm lg:text-[0.95rem] xl:text-[1.05rem] text-[#374151] font-sans mt-3 md:mt-4" style={{ lineHeight: '1.6' }}>
                You agree to receive all current and future notices, disclosures, communications and information, and to do business electronically with Uncle Sam Buys Homes and Providers. This means that Uncle Sam Buys Homes and Providers may communicate with you by sending a message to the email address you provided or at another address that may be associated with you that we receive from Providers or other parties. You agree that you meet the below technical requirements and are able to access and retain copies of notices and information sent or made available electronically.
              </p>
              <p className="text-sm lg:text-[0.95rem] xl:text-[1.05rem] text-[#374151] font-sans mt-3 md:mt-4" style={{ lineHeight: '1.6' }}>Technical Requirements To access and retain information and notices we send or make available to you electronically, you will need:</p>
              <ul className="list-disc list-inside space-y-1 text-sm lg:text-[0.95rem] xl:text-[1.05rem] text-[#374151] font-sans ml-4 md:ml-6 mt-2" style={{ lineHeight: '1.6' }}>
              ...
              <p className="text-sm lg:text-[0.95rem] xl:text-[1.05rem] text-[#374151] font-sans mt-3 md:mt-4" style={{ lineHeight: '1.6' }}>
                You have the right to receive any document in non-electronic form and to withdraw your consent to electronic delivery at any time by contacting Uncle Sam Buys Homes at{' '}
                <a href="mailto:contact@unclesambuyshomes.com" className="text-blue-600 hover:text-blue-800 underline">contact@unclesambuyshomes.com</a>.
              </p>
            </div>

            <div className="terms-section mt-4 md:mt-6">
              <h3 className="text-xl lg:text-2xl xl:text-3xl font-bold text-[#111827] font-sans">11. INTELLECTUAL PROPERTY RIGHTS.</h3>
              <p className="text-sm lg:text-[0.95rem] xl:text-[1.05rem] text-[#374151] font-sans mt-3 md:mt-4" style={{ lineHeight: '1.6' }}>
            ...
            <div className="terms-section mt-4 md:mt-6">
              <h3 className="text-xl lg:text-2xl xl:text-3xl font-bold text-[#111827] font-sans">12. DISCLAIMER OF WARRANTIES.</h3>
              <p className="text-sm lg:text-[0.95rem] xl:text-[1.05rem] text-[#374151] font-sans mt-3 md:mt-4" style={{ lineHeight: '1.6' }}>
              ...
              <p className="text-sm lg:text-[0.95rem] xl:text-[1.05rem] text-[#111827] font-sans font-semibold mt-3 md:mt-4" style={{ lineHeight: '1.6' }}>
            ...
            <div className="terms-section mt-4 md:mt-6">
              <h3 className="text-xl lg:text-2xl xl:text-3xl font-bold text-[#111827] font-sans">13. LIMITATION OF LIABILITY.</h3>
              <p className="text-sm lg:text-[0.95rem] xl:text-[1.05rem] text-[#111827] font-sans font-semibold mt-3 md:mt-4" style={{ lineHeight: '1.6' }}>
            ...
            <div className="terms-section mt-4 md:mt-6">
              <h3 className="text-xl lg:text-2xl xl:text-3xl font-bold text-[#111827] font-sans">14. EXCLUSIONS AND LIMITATIONS.</h3>
              <p className="text-sm lg:text-[0.95rem] xl:text-[1.05rem] text-[#111827] font-sans font-semibold mt-3 md:mt-4" style={{ lineHeight: '1.6' }}>
            ...
            <div className="terms-section mt-4 md:mt-6">
              <h3 className="text-xl lg:text-2xl xl:text-3xl font-bold text-[#111827] font-sans">15. MONITORING WEBSITE USAGE.</h3>
              <p className="text-sm lg:text-[0.95rem] xl:text-[1.05rem] text-[#374151] font-sans mt-3 md:mt-4" style={{ lineHeight: '1.6' }}>
            ...
            <div className="terms-section mt-4 md:mt-6">
              <h3 className="text-xl lg:text-2xl xl:text-3xl font-bold text-[#111827] font-sans">16. INDEMNITY.</h3>
              <p className="text-sm lg:text-[0.95rem] xl:text-[1.05rem] text-[#374151] font-sans mt-3 md:mt-4" style={{ lineHeight: '1.6' }}>
                You agree to defend, indemnify and hold Company, its parents, subsidiaries, partners, agents, affiliates, licensors, providers, successors and assigns and their respective officers, directors, employees and shareholders harmless from any and all claims, liabilities, costs and expenses, including reasonable attorneys fees, arising in any way from, in connection with or as a result of your use or inability to use the Website and or Website Content, any information provided to you by the Website, or any violation of TOU by you. YOU HEREBY AGREE TO WAIVE ALL LAWS THAT MAY LIMIT THE EFFICACY OF SUCH RELEASES. FOR EXAMPLE, YOU SPECIFICALLY AGREE TO WAIVE THE PROVISIONS OF CALIFORNIA CIVIL CODE SECTION 1542, WHICH PROVIDES; &quot;A GENERAL RELEASE DOES NOT EXTEND TO CLAIMS WHICH THE CREDITOR DOES NOT KNOW OR SUSPECT TO EXIST IN HIS FAVOR AT THE TIME OF EXECUTING THE RELEASE, WHICH IS KNOWN BY HIM, MUST HAVE MATERIALLY AFFECTED HIS SETTLEMENT WITH THE DEBTOR.&quot;
              </p>
            </div>

            <div className="terms-section mt-4 md:mt-6">
              <h3 className="text-xl lg:text-2xl xl:text-3xl font-bold text-[#111827] font-sans">17. RELEASE.</h3>
              <p className="text-sm lg:text-[0.95rem] xl:text-[1.05rem] text-[#111827] font-sans font-semibold mt-3 md:mt-4" style={{ lineHeight: '1.6' }}>
            ...
            <div className="terms-section mt-4 md:mt-6">
              <h3 className="text-xl lg:text-2xl xl:text-3xl font-bold text-[#111827] font-sans">18. DEALINGS WITH THIRD PARTIES.</h3>
              <p className="text-sm lg:text-[0.95rem] xl:text-[1.05rem] text-[#374151] font-sans mt-3 md:mt-4" style={{ lineHeight: '1.6' }}>
            ...
            <div id="dispute-resolution" className="terms-section mt-4 scroll-mt-24 md:mt-6">
            ...
            <div className="terms-section mt-4 md:mt-6">
              <h3 className="text-xl lg:text-2xl xl:text-3xl font-bold text-[#111827] font-sans">20. WAIVER AND SEVERABILITY OF TERMS.</h3>
              <p className="text-sm lg:text-[0.95rem] xl:text-[1.05rem] text-[#374151] font-sans mt-3 md:mt-4" style={{ lineHeight: '1.6' }}>
            ...
            <div className="terms-section mt-4 md:mt-6">
              <h3 className="text-xl lg:text-2xl xl:text-3xl font-bold text-[#111827] font-sans">23. STATUTE OF LIMITATIONS.</h3>
              <p className="text-sm lg:text-[0.95rem] xl:text-[1.05rem] text-[#111827] font-sans font-semibold mt-3 md:mt-4" style={{ lineHeight: '1.6' }}>
            ...
            <div className="terms-section mt-4 md:mt-6">
              <p className="text-sm lg:text-[0.95rem] xl:text-[1.05rem] text-[#374151] font-sans font-semibold" style={{ lineHeight: '1.6' }}>PLEASE PRINT AND RETAIN A COPY OF THIS AGREEMENT FOR YOUR RECORDS.</p>
              <p className="text-sm lg:text-[0.95rem] xl:text-[1.05rem] text-[#374151] font-sans mt-3" style={{ lineHeight: '1.6' }}>If you have any questions regarding this Terms of Use, please contact: <a href="mailto:contact@unclesambuyshomes.com" className="text-blue-600 hover:text-blue-800 underline">contact@unclesambuyshomes.com</a></p>
              <p className="text-sm lg:text-[0.95rem] xl:text-[1.05rem] text-[#374151] font-sans" style={{ lineHeight: '1.6' }}>1985 Del Amo Blvd #P2150, Torrance, CA, 90501</p>
            </div>
