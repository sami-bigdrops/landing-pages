...
const INPUT_FIELD =
  "mt-0 h-14 w-full rounded-[10px] border border-gray-300 bg-white px-4 text-sm text-[#111827] shadow-[0_4px_12px_0_rgba(0,0,0,0.03)] focus:border-[#102E50] focus:outline-none xl:h-15 xl:text-base"
      ...
      <div className="container mx-auto">
        <div className="hero-content flex flex-col items-center justify-center gap-8">
          ...
          <div className="mx-auto flex w-full max-w-4xl flex-col items-center gap-6">
            <h3 className="text-center text-xl  font-bold text-[#142B4A] xl:text-2xl ">How much debt do you have?</h3>

            <div className="w-full flex flex-col-reverse items-center justify-center gap-4">
          ...
          <PartnerLogos className="w-full mt-2"/>
        </div>
      </div>
    </div>
  )
