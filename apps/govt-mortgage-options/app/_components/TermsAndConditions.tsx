        ...
        <div className="prose prose-lg max-w-none">
          <div className="space-y-8">
            ...
            <section className="mt-12 p-4 sm:p-6 bg-gray-50 rounded-lg">
              ...
              <p className="text-sm sm:text-base text-gray-700 leading-relaxed mb-4">
                If you have any questions regarding this Terms of Use, please contact: <a href="mailto:contact@govmortgageoptions.com" className="text-[#1E3A8A] hover:underline font-medium">contact@govmortgageoptions.com</a>
              </p>
              <p className="text-sm sm:text-base text-gray-700 leading-relaxed">
