...
export function StepDriver3Accidents({ value, onChange }: StepDriver3AccidentsProps) {
  return (
    <div>
      ...
      <div className="grid grid-cols-4 gap-3 md:gap-4" role="radiogroup" aria-label="Third driver at-fault accidents">
        {OPTIONS.map((option) => {
          ...
          return (
            ...
            >
              <span className="text-2xl xl:text-3xl font-bold tabular-nums" style={{ color: FORM_PRIMARY_COLOR }}>
                {option}
              </span>
            </button>
          )
