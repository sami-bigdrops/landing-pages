...
interface StepDriver2CreditScoreProps {
  value: string
...
export function StepDriver2CreditScore({ value, onChange }: StepDriver2CreditScoreProps) {
  return (
    <div>
      <h2
      ...
      >
        What is your second driver&apos;s credit score?
      </h2>

      <div className="grid grid-cols-1 gap-3 md:gap-4" role="radiogroup" aria-label="Second driver credit score">
        {OPTIONS.map((option) => {
