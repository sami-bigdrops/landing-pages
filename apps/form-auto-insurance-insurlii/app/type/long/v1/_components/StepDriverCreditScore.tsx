...
interface StepDriverCreditScoreProps {
  value: string
...
export function StepDriverCreditScore({ value, onChange }: StepDriverCreditScoreProps) {
  return (
    <div>
      <h2
      ...
      <div className="grid grid-cols-1 gap-3 md:gap-4" role="radiogroup" aria-label="Credit score">
        {OPTIONS.map((option) => {
