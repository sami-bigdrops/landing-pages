...
interface StepDriverAccidentsProps {
  value: string
...
export function StepDriverAccidents({ value, onChange }: StepDriverAccidentsProps) {
  return (
    <div>
      <h2
      ...
      >
        How many at-fault accidents have you had in the past three (3) years?
      </h2>
