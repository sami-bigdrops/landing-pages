...
export function StepDriver3Education({ value, onChange }: StepDriver3EducationProps) {
  ...
  return (
    <div>
      ...
      >
        What is your third driver&apos;s education level?
      </h2>

      <div
        className="grid grid-cols-2 gap-3 md:gap-4 mb-4"
        role="radiogroup"
        aria-label="Third driver education level"
      >
        {GRID_OPTIONS.map((option) => {
          ...
          return (
            ...
            >
              <span className="text-sm font-semibold leading-tight" style={{ color: FORM_PRIMARY_COLOR }}>
                {option}
              </span>
              <span
                className={cn(
                ...
                style={isSelected ? { borderColor: FORM_SELECTED_BORDER, backgroundColor: FORM_SELECTED_BORDER } : undefined}
                aria-hidden
              >
