...
interface StepDriverGenderProps {
  value: string
...
export function StepDriverGender({ value, onChange }: StepDriverGenderProps) {
  return (
    <div>
      <h2
      ...
      <div className="grid grid-cols-1 gap-3 md:gap-4" role="radiogroup" aria-label="Gender">
        {OPTIONS.map((option) => {
