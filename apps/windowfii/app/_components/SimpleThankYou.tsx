  ...
  if (isLoading) {
    ...
    return (
      <main className="flex min-h-[50vh] items-center justify-center bg-white px-6 py-20">
        <div className="h-12 w-12 animate-spin rounded-full border-2 border-gray-200 border-t-[#2B75FB]" />
      </main>
    )
  }
  ...
  return (
    <main className="flex flex-1 items-center justify-center bg-white px-6 py-16 md:py-24">
      <div className="mx-auto max-w-xl text-center">
        <div
          className="mx-auto mb-6 flex h-16 w-16 items-center justify-center rounded-full bg-[#10b981] md:mb-7 md:h-20 md:w-20"
          aria-hidden
        >
          <Check className="h-8 w-8 text-white md:h-10 md:w-10" strokeWidth={3} />
        </div>
        <h1 className="text-3xl font-bold tracking-tight text-[#0E2651] md:text-4xl">
          {title}
        </h1>
        <p
          className="mt-5 text-base font-normal text-[#464F5B] md:text-lg"
