  ...
  try {
    ...
    if (hasLeadProsper) {
      const formData = {
        ...
        medicare_parts: String(medicareParts ?? "").trim(),
        date_of_birth: String(dateOfBirth ?? "").trim(),
        tcpa: 'By clicking "Agree, Review Plans," you agree to the consents below the button, including your consent to be contacted and your authorization for the use and disclosure of your health information. No obligation to enroll.',
        ip_address: ip,
