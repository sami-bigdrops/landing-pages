...
export const OFFER_CONTENT = {
  headline: "Check Your Medicare Options",
  subtext: "Answer a few quick questions so we can help you compare plans that fit your doctors, prescriptions, and budget.",
  subtitle: "Are you currently on Medicare or becoming eligible soon?",
} as const
